        ...
        <main className={"MainFrame"}>
            ...
            <div classname={"Content"}>
                <div className={"ConnectMethod"}>
                    <button className={"ConnectBtn"} onClick={initEthers}>Connect to MetaMask by ethers.js</button>
                    <h2 className={"ConnectAddr"}>帳戶地址: {ethersAddress}</h2>
                    <h2 className={"ConnectAmount"}>帳戶餘額: {ethersAmount} ETH</h2>
                </div>
                <div className={"ConnectMethod"}>
                    <button className={"ConnectBtn"} onClick={initWeb3}>Connect to MetaMask by web3.js</button>
